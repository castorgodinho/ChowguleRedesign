  ...
  <div class="pcc-loader">
	...
	if(request.getParameter("course") != null ){
		...
		if(martialStatus.equalsIgnoreCase("unmarried")){
			...
			partner.insertParentGaurdian(studentid);
		...
		compatibilityID = subject1.getCompatibleID(subjectid);
	    ...
	    admissionDetails.setDegreeID(3);
	...
	<div class="container" style="margin-top: 250px;">
		...
		<form class="fy-admission-form" action="" method="POST">
			<h1 class="text-center" style="margin-top: 10px;">Post Graduation
				Admissions Form</h1>
			<div class="text-left">
				...
				<div style="width: 250px; margin-bottom: 30px;">
					<h4>Subject</h4>
					<select class="form-control subject-div" name="subjectid" required>
						...
						<div class="panel-body">
							...
							<div class="form-group">
								<div class="row">
									...
									<div class="col-lg-4">
										<label>Religon</label> <select class="form-control"
									...
									<div class="col-lg-4">
										<label>Caste</label> <select class="form-control" name="caste"
											required>
								...
								<div class="row">
									...
									<div class="col-lg-4">
										<label>Physically Challenged</label><br /> <label class="">
											<input type="radio" name="physicallyChallenged"
											id="inlineRadio1" value="yes" required> Yes
										</label> <label class=""> <input type="radio"
											name="physicallyChallenged" id="inlineRadio2" value="no"
											checked="checked" required> No
										</label>
									</div>
								...
								<div class="row">
									<div class="col-lg-6">
										...
										<label>Country</label> <select name="country"
											...
											class="form-control co-state" name="state" placeholder=" "
											required> <label>City/Town</label> <input type="text"
											class="form-control co-city" placeholder=" " name="cityTown"
											...
											class="form-control co-pincode" placeholder=" "
									...
									<div class="col-lg-6">
										...
										<textarea class="form-control pr-address" rows="3"
											name="permanentfullAddress" required></textarea>
										<label>Country</label> <select name="permanentCountry"
											class="form-control pr-country" required>
											<option>Indian</option>
											<option>USA</option>
										</select> <label>State</label> <input type="text"
											class="form-control pr-state" name="permanentState"
											placeholder=" " required> <label>City/Town</label> <input
											type="text" name="permanentCityTown"
											class="form-control pr-city" placeholder=" " required>
										<label>Taluka</label> <input type="text"
											name="permanentTaluka" class="form-control pr-taluka"
											placeholder=" " required> <label>Pincode</label> <input
								...
								<div class="row">
									<div class="col-lg-4">
										<label>Contact/ Mobile Number</label> <input type="text"
											class="form-control" name="contactMobileNumber"
											placeholder=" " required>
									</div>
									<div class="col-lg-4">
										<label>Alternate Number</label> <input type="text"
											class="form-control" placeholder=" " name="alternativeNumber"
											required>
									</div>
									<div class="col-lg-4">
					...
					<div class="panel panel-primary">
						...
						<div class="panel-body">
							<div class="form-group">
								<div class="row">
									<div class="col-lg-4">
										<label>Name Of the College</label> <input type="text"
											class="form-control" placeholder=" " name="hsscNameOfSchool"
											required>
									</div>
									<div class="col-lg-4">
								...
								<div class="row">
									...
									<div class="col-lg-4">
										<label>Marks Obtained</label> <input type="text"
											class="form-control" placeholder=" " name="hsscMarksObtained"
											required>
									</div>
									<div class="col-lg-4">
										<label>Total Marks(Out of)</label> <input type="text"
											class="form-control" placeholder=" " name="hsscTotalMarks"
											required>
									</div>
									<div class="col-lg-4">
										<label>Grade</label> <input type="text" class="form-control"
											placeholder=" " name="hsscGrade" required>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="panel panel-primary">
							...
							<div class="panel-body">
								<div class="terms-conditions-div panel panel-info">
									...
									<div class="text-justify panel-body">I hereby apply for
										the admission to "Parvatibai Chowgule College of Arts and
										Science". I submit that the information given herein by me is
										true and correct to the best of my knowledge and that no part
										of it is false. In case it is found that any material
										information is suppressed and/or untrue, the Principal shall
										be free to cancel my admission and that I shall not have any
										claim for damages or otherwise against the college. I have
										read and understood the disciplinary and general rules in the
										college prospectus & I am aware of the timings (TimeTable) of
										my class and I agree to abide by the same & I accept the same.
										I shall follow all the rules and shall accept the decision
										given by the Principal on all the matters including the
										matters of rejecting the application, admission and/or
										discipline. I have noted Rules No. 6, 15 and 16 mentioned as
										Rules of Discipline in the college prospectus for 2015-16 and
										I shall abide by them along with other rules. I accept and
										agree with the mode of submitting application for admission on
										line as prescribed by the college. I agree and undertake that
										the decision of the Principal of college relating to the
										admission shall be final and binding on me. I undertake to
										sign the hard copy of my application as and when required by
										the college. I have also read and understood the Goa
										University/Board Statutes and Ordinances governing admission,
										rate of fees, refund of fees, course of study, examinations,
										eligibility conditions etc., as applicable from time to time
										and I undertake to abide by them. I accept and undertake to
										abide by Goa University's/Board statutes, ordinances and other
										rules governing my admission, courses, examinations, fees,
										refund of fees etc., as applicable form time to time. That any
										dispute arising in respect of application for admission and/or
										Admission or rejection thereof shall be subject to the
										Jurisdiction of Margao. I accept and undertake to abide by
										rules stated in the college Sports Policy, College IT & Cyber
										Crime Policy and College Plagiarism Policy. NATIONAL RAGGING
										PREVENTION PROGRAM On Line Affidavit are given on
										www.amanmovement.org.</div>
								</div>
								<div class="form-group">
									<div class="row">
										<div class="col-lg-6">
											<label class="radio-inline terms-condition-radio"> <input type="radio"
												checked="false" 
												 required> I accpet the terms and condition <br />
												<h5 class="terms-condtions">Read the terms and
													condition</h5>
											</label>
										</div>
    ...
    $(document).ready(function () {
    	 $('.terms-condition-radio').prop('checked', false);
