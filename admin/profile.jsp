...
<body>
  <body class="home">
    <div class="display-table">
        ...
        <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box card-style-container" id="navigation">
          ...
          <div class="navi">
            <ul class="nav">
              ...
              <li class="active"><a href="dash_attendance.html"><i class="fa fa-tasks" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Attendance</span></a></li>
              ...
              <li><a href="dash_exam.html"><i class="fa fa-user" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Examination</span></a></li>
                    ...
                    <div class="col-md-12 card-style attendance-container " >
                      ...
                      <div class="row">
                        <div class="col-md-3">
                          <div class="col-md-12">
                            <div class="row">
                              <div class="col-md-12 rmv-padding-col">
                                <div class="thumbnail" style="box-shadow:0px 0px 10px #595959;">
                                  <img src="../img/avatar.jpg" class="img-responsive">
                                </div>
                              </div>
                              <div class="col-md-12 rmv-padding-col">
                                <a href="#" class="btn btn-block btn-warning">EDIT PROFILE</a>
                              </div>
                            </div>
                          </div>
      ...
      <tbody>
        <tr>
           <td colspan="2"><h3>VASKAR TUSHAR RAGHOBA</h3><h4>SU1515100</h4>
    ...
    <tr>
      ...
      <tbody>
        <tr>
           <th colspan="2" class=""><h4 class="text-center">PARENT DETAILS</h4></th>
    ...
    <tr>
        ...
        <td>: 9850378557</td>
                        ...
                        <div class="col-md-12">
                          ...
                          <tbody>
                            <tr>
                               <th colspan="2"><h4 class="text-center">EDUCATIONAL BACKGROUND</h4></th>
