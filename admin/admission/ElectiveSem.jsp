<%-- 
    Document   : ElectiveSem
    Created on : 16 Mar, 2017, 9:45:26 PM
    Author     : gaurav
--%>
                                ...
                                <div class="">
                                    <%
                                        ...
                                        if (request.getParameter("insertButton") != null) {
                                            try {
                                                ...
                                                String electiveSem[] = request.getParameterValues("sem");
                                                ...
                                                int sem1[] = new int[electiveSem.length];

                                                for (int i = 0; i < sem1.length; i++) {
                                                    sem1[i] = Integer.parseInt(electiveSem[i]);
                                    ...
                                    <form action="" method="post">
                                        <div class="col-md-12 card-style attendance-container " >
                                            <h3 class="text-center">ADD ELECTIVE SEM</h3>
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-4 col-md-offset-2">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" name="papers" id="papers">
                                                                ...
                                                                <%
                                                                    Elective elective[] = Elective.getAllElectivePapers(con);
                                                                    for (int i = 0; i < elective.length; i++) {
                                                                        int paperID = elective[i].getPaperID();
                                                                        out.println("<option value=" + paperID + "> " + elective[i].getPaperName() + "</option>");
                                                                    }
                                            ...
                                            <div class="attend-scroll">
                                                <div class="col-md-12">
                                                    <div class="panel panel-success">
                                                        <h3 class="text-center">ELECTIVE SEM DIRECTORY</h3>
                                                        ...
                                                        <table class="table table-hover" id="task-table">
                                                            ...
                                                            <tbody>
                                                                <%                                                                   
                                                                    ...
                                                                    PaperSem papersem[] = papersems.getElectivePaperSem();
