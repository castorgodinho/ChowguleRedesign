<%-- 
    Document   : CoreSem
    Created on : 16 Mar, 2017, 9:18:45 PM
    Author     : gaurav
--%>
                                ...
                                <div class="">
                                    <%
                                        ...
                                        if (request.getParameter("insertButton") != null) {
                                            try {
                                                ...
                                                String coreSem[] = request.getParameterValues("sem");
                                                ...
                                                int sem1[] = new int[coreSem.length];

                                                for (int i = 0; i < sem1.length; i++) {
                                                    sem1[i] = Integer.parseInt(coreSem[i]);
                                    ...
                                    <form action="" method="post">
                                        <div class="col-md-12 card-style attendance-container " >
                                            <h3 class="text-center">ADD CORE SEM</h3>
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-4 col-md-offset-2">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" name="papers" id="papers">
                                                                ...
                                                                <%
                                                                    Core core[] = Core.getAllCorePapers(con);
                                                                    for (int i = 0; i < core.length; i++) {
                                                                        int paperID = core[i].getPaperID();
                                                                        out.println("<option value=" + paperID + "> " + core[i].getPaperName() + "</option>");
                                                                    }
                                            ...
                                            <div class="attend-scroll">
                                                <div class="col-md-12">
                                                    <div class="panel panel-success">
                                                        <h3 class="text-center">CORE SEM DIRECTORY</h3>
                                                        ...
                                                        <table class="table table-hover" id="task-table">
                                                            ...
                                                            <tbody>
                                                                <%                                                                    PaperSem papersems = new PaperSem(con);
                                                                    PaperSem papersem[] = papersems.getCorePaperSem();
