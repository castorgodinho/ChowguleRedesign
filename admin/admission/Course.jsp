                                        ...
                                        <div class="col-md-12 card-style attendance-container " >
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <input type="submit"  name="insertButton" class="btn btn-warning pull-right btn-block" value="INSERT COURSE" id="insertButton">
                                                    <input type="submit"  name="updateButton" class="btn btn-warning pull-right btn-block" value="UPDATE COURSE" id="updateButton">
                                                </div>
                                            </div>
