<%-- 
    Document   : GeneralSem
    Created on : 16 Mar, 2017, 9:56:57 PM
    Author     : gaurav
--%>
                                ...
                                <div class="">
                                    <%
                                        ...
                                        if (request.getParameter("insertButton") != null) {
                                            try {
                                                ...
                                                String generalSem[] = request.getParameterValues("sem");
                                                ...
                                                int sem1[] = new int[generalSem.length];

                                                for (int i = 0; i < sem1.length; i++) {
                                                    sem1[i] = Integer.parseInt(generalSem[i]);
                                                    papersem.setSem(sem1[i]);
                                                    papersem.insertPaperSem();
                                                    
                                                }
                                                out.println("<div class=\"alert alert-success\" id=\"insertSuccess\">"
                                                            + "<strong>Success!</strong>  general sem added successfully!."
                                                            + "</div>");
                                            } catch (SQLException sqlexception) {
                                                out.println("<div class=\"alert alert-danger\" id=\"invalid\">"
                                                        + "<strong>Invalid!</strong> general sem already exists!."
                                                        + "</div>");
                                            ...
                                            try {
                                                ...
                                                out.println("<div class=\"alert alert-success\" id=\"insertSuccess\">"
                                                        + "<strong>Success!</strong>  general sem deleted successfully!."
                                                        + "</div>");
                                            } catch (SQLException sqlexception) {
                                                out.println("<div class=\"alert alert-danger\" id=\"invalid\">"
                                    ...
                                    <form action="" method="post">
                                        <div class="col-md-12 card-style attendance-container " >
                                            <h3 class="text-center">ADD GENERAL SEM</h3>
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-4 col-md-offset-2">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" name="papers" id="papers">
                                                                ...
                                                                <%
                                                                    General general[] = General.getAllGeneralPapers(con);
                                                                    for (int i = 0; i < general.length; i++) {
                                                                        int paperID = general[i].getPaperID();
                                                                        out.println("<option value=" + paperID + "> " + general[i].getPaperName() + "</option>");
                                                                    }
                                            ...
                                            <div class="attend-scroll">
                                                <div class="col-md-12">
                                                    <div class="panel panel-success">
                                                        <h3 class="text-center">GENERAL SEM DIRECTORY</h3>
                                                        ...
                                                        <table class="table table-hover" id="task-table">
                                                            ...
                                                            <tbody>
                                                                <%                                                                  
                                                                    ...
                                                                    PaperSem papersem[] = papersems.getGeneralPaperSem();
