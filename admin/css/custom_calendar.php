$your_google_calendar="https://calendar.google.com/calendar/embed?showTitle=0&amp;showPrint=0&amp;showCalendars=0&amp;showTz=0&amp;height=600&amp;wkst=2&amp;bgcolor=%23ffffff&amp;src=95hjstlatf5e095keugrhaa32k%40group.calendar.google.com&amp;color=%23AB8B00&amp;ctz=Asia%2FCalcutta";
$url= parse_url($your_google_calendar);
$google_domain = $url['scheme'].'://'.$url['host'].dirname($url['path']).'/';
// Load and parse Google's raw calendar
$dom = "css/custom_calender.css";
