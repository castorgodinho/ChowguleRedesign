...
<table class="table table-bordered ">
	...
	<tbody>
		<tr>
			...
			<div class="progress">
			<div class="progress-bar" role="progressbar" aria-valuenow="85" aria-valuemin="0" aria-valuemax="100"><span class="popOver" data-toggle="tooltip" data-placement="top" title="85%"> </span></div>
			</div>
			</div>
			</th>
		</tr>
		<tr>
			...
			ARCHITECTURE</B></span>
			<div class="progress ">
			<div class="progress-bar" role="progressbar" aria-valuenow="75" aria-valuemin="10" aria-valuemax="100" style=""><span class="popOver" data-toggle="tooltip" data-placement="top" title="75%"> </span></div>
			</div>
			</div>
			</th>
		</tr>
...
<h4 class="text-center">MY TARGETS</h4>
<table class="table table-bordered ">
	<thead class="">
		<tr>
			<th colspan="3">
