  ...
  <%@ include file="header.jsp"%>
    <div class="container" style="min-height:100vh;margin-top:250px;">
      <div class="row card-style view-gallery" id="links" style="">
        <h3 class="text-center">MINEKRAFT 2017</h3><hr/>
        <div class="col-lg-4">
      <a href="img/28.jpg" title="Banana" class="img-responsive">
          <img src="img/28.jpg" alt="Banana" class="img-responsive">
      </a>
        </div>
        <div class="col-lg-4">
      <a href="img/29.jpg" title="Banana" class="img-responsive">
          <img src="img/29.jpg" alt="Banana" class="img-responsive">
      </a>
        </div>

        <div class="col-lg-4">
          <a href="img/30.jpg" title="Banana" class="img-responsive">
              <img src="img/30.jpg" alt="Banana" class="img-responsive">
          </a>
        </div>
        <div class="col-lg-4">
          <a href="img/31.jpg" title="Banana" class="img-responsive">
              <img src="img/31.jpg" alt="Banana" class="img-responsive">
          </a>
        </div>
        <div class="col-lg-4">
          <a href="img/32.jpg" title="Banana" class="img-responsive">
              <img src="img/32.jpg" alt="Banana" class="img-responsive">
          </a>
        </div>
